            ...
            <div className="flex flex-col gap-[26px] w-full relative z-10">
                <div className="flex flex-col items-center justify-center gap-4 self-stretch w-full text-center">
                    ...
                    <div className="leading-5">
                        {tt("Open-Source AI-Integrated Terminal")}
                        <br />
                        {tt("Built for Seamless Workflows")}
                    </div>
                </div>
                <div className="items-center gap-4 self-stretch w-full text-center">
                    {tt("Client Version {version}", { version: versionString })}
                    <br />
                    {tt("Update Channel: {channel}", { channel: updaterChannel })}
                </div>
