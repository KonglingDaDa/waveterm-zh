                    ...
                    <div className="bg-blue-900/20 border border-blue-500 rounded-lg p-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="text-left">
                                <div className="text-blue-400 font-medium mb-1">{tt("Telemetry keeps Wave AI free")}</div>
                                <div className="text-secondary text-sm mb-3">
                                    ...
                                    <p>
                                        {tt("For information about BYOK and local model support, see")}{" "}
                                        <a
                                ...
                                >
                                    {isEnabling ? tt("Enabling...") : tt("Enable Telemetry and Continue")}
                                </button>
                            </div>
                        </div>
                    </div>
